...
library(data.table)
r_25 = fread('./Simulation/smoothingP0_0.25.txt')
r_50 = fread('./Simulation/smoothingP0_0.50.txt')
r_75 = fread('./Simulation/smoothingP0_0.75.txt')
...
text(x=13.5, y=-0.02,xpd=TRUE, labels="simulation settings")