...
setwd("C:/ShareCache/王鑫培_2111110203/AAA小论文/REAL DATA/GWAS summary data")
...
## DBP ##
a = fread("Evangelou_30224653_DBP.txt")  # 没有rsID，只有位置信息
library("tidyr")
...
## SBP ##
a = fread("Evangelou_30224653_SBP.txt")  # 没有rsID，只有位置信息
library("tidyr")
a = a[which(a$P<5e-8),]
b = separate(a,'MarkerName',c('chr','pos','type'),sep = ":")
all = fread('variants.tsv')
...
## 把这11个暴露的IV合成一个List ##
setwd('C:/ShareCache/王鑫培_2111110203/AAA小论文/REAL DATA/GWAS summary data/IV')
folder_path <- getwd()
